      ...
      >
        ...
        <header className="bg-white shadow-md p-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold text-gray-800">Meat Inspection Records</h1>
          </div>
        </header>
              ...
              <tbody>
                {filteredRecords.length === 0 ? (
                  ...
                  filteredRecords.map((record, index) => (
                    ...
                    >
                      <td className="px-6 py-4">{formatDate(record.date_of_inspection)}</td>
                      <td className="px-6 py-4">{formatTime(record.time)}</td>
                      <td className="px-6 py-4 font-medium">{record.dealer_name}</td>
                      <td className="px-6 py-4">{record.kilos} kg</td>
                      <td className="px-6 py-4">{formatDate(record.date_of_slaughter)}</td>
