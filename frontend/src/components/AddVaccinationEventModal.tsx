...
interface AddVaccinationEventModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (event: VaccinationEvent) => void;
}

const AddVaccinationEventModal: React.FC<AddVaccinationEventModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
}) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800">Schedule New Vaccination Event</h2>
          <button
            onClick={onClose}
...
export default AddVaccinationEventModal; 