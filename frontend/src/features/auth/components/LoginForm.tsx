    ...
    <form onSubmit={(e) => e.preventDefault()}>
      ...
      <div className="mb-6">
        <div className="relative flex items-center">
          <div className="flex-1 bg-green-700 rounded-lg border border-green-600 p-4">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <label className="block text-xs text-gray-300 mb-2">Security Check</label>
                <p className="text-white text-lg font-semibold">{captchaQuestion}</p>
                <input
                  type="number"
                  placeholder="Enter answer"
                  value={captchaAnswer}
                  onChange={(e) => setCaptchaAnswer(e.target.value)}
                  className="w-full mt-2 px-3 py-2 rounded bg-green-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-400 border border-green-600"
                />
              </div>
              <button
                type="button"
                onClick={generateCaptcha}
                className="ml-4 p-2 text-gray-300 hover:text-white transition-colors"
